            ...
            children: <Widget>[
              ListTile(
                leading: Container(
                  ...
                  decoration: new BoxDecoration(border: new Border(right: new BorderSide(width: 1.0, color: Colors.black26))),
                  child: Icon(Icons.language, color: Colors.black38),
                ),
                title: Text(allTranslations.text("settings.languages.option"), style: TextStyle(color: Colors.black, fontSize: 16.0, fontWeight: FontWeight.bold)),
                // subtitle: Text("Change App Language", style: TextStyle(color: Colors.grey.shade400)),
                trailing: Icon(Icons.keyboard_arrow_right, color: Colors.black, size: 30.0),
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => LanguageScreen()));
                },
              ),
              SwitchListTile(
                title: Text(allTranslations.text("settings.pushNotifications"), style: TextStyle(color: Colors.black)),
                subtitle: Text(
